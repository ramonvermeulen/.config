# Generated by Powerlevel10k configuration wizard on 2026-01-06 at 15:24 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_GCLOUD_PARTIAL_CONTENT_EXPANSION='${P9K_GCLOUD_CONFIGURATION//\%/%%}'
  typeset -g POWERLEVEL9K_GCLOUD_COMPLETE_CONTENT_EXPANSION='${P9K_GCLOUD_CONFIGURATION//\%/%%}'
